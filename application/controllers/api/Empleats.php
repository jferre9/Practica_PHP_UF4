 ...
 */
class Empleats extends REST_Controller {
    ...
    public function getKey_post() {
        ...
        if ($this->post("user") == "admin" && $this->post("pass") == "admin") {
    ...
    public function afegir_post() {
        ...
        $nom = $this->post("nom");
        $departament = $this->post("departament");
        
        $this->response([
                'status' => TRUE,
                'message' => "Nom = $nom departament = $departament"
