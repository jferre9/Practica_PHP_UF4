        ...
        <div class="container">
            <div class="card card-container">
                ...
                <form class="form-signin" method="post">
                    ...
                    <input type="text" name="email" id="inputEmail" class="form-control" placeholder="Usuari" required autofocus>
                    <input type="password" name="pass" id="inputPassword" class="form-control" placeholder="Contrasenya" required>
